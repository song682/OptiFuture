...
public class MCPatcherForgeMixinPlugin implements IMixinConfigPlugin {
    ...
    public static final String EARLY_PACKAGE = "decok.dfcdvadstf.optifuture.mixins.early";
    /** Mixin root package of the late config. / late 配置的 mixin 根包。 */
    public static final String LATE_PACKAGE = "decok.dfcdvadstf.optifuture.mixins";
