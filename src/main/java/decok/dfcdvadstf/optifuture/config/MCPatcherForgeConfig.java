package decok.dfcdvadstf.optifuture.config;
...
public class MCPatcherForgeConfig {
    ...
    /** Custom world loading screens via loading.properties. / 基于 loading.properties 的自定义世界加载屏幕。 */
    public boolean customLoadingScreens;
    ...
    public MCPatcherForgeConfig(File file) {
        ...
        customLoadingScreens = config.get(Category.BETTER_SKIES.toString(),"customLoadingScreens",true,"Enable custom world loading screens (loading.properties)").getBoolean();
